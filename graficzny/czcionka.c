...
const uint8_t font_8x8[128][8] = {
    ...
    ['W'] = {0x66, 0x66, 0x66, 0x6E, 0x7E, 0x76, 0x66, 0x00},
    ...
    ['w'] = {0x00, 0x00, 0x66, 0x66, 0x6E, 0x7E, 0x76, 0x00},
    ...
    ['!'] = {0x18, 0x18, 0x18, 0x18, 0x00, 0x18, 0x00, 0}, // xddddd nawet wczesniej nie moglo sie napisac poprawnego zdania
    ['?'] = {0x3C, 0x66, 0x06, 0x1C, 0x18, 0x00, 0x18, 0},
};
...
void rysuj_znak_8x8(int x, int y, char znak, uint8_t kolor)
{
    ...
    for (int pion = 0; pion < 8; pion++)
        for (int poziom = 0; poziom < 8; poziom++)
